...
export type { ArcTestnetDegenNFT } from "./contracts/ArcTestnetDegenNFT";
export { ArcTestnetDegenNFT__factory } from "./factories/contracts/ArcTestnetDegenNFT__factory";
