...
export interface ArcTestnetDegenNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "TOKEN_URI"
      | "approve"
...
export interface ArcTestnetDegenNFT extends BaseContract {
  connect(runner?: ContractRunner | null): ArcTestnetDegenNFT;
  waitForDeployment(): Promise<this>;

  interface: ArcTestnetDegenNFTInterface;
